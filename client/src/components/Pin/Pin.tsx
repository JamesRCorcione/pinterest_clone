  ...
  return (  
    <Box>
      ...
      >
        ...
        {!postHovered 
          ?
           <img className={classes.imageOp} height={'auto'} width={'100%'} aspect-ration={16/10} alt="user-post" src={image}  /> 
          : 
          <>
            <img className={classes.image} height={'auto'} width={'100%'} aspect-ration={16/10} alt="user-post" src={image}  />
