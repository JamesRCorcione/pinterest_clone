  ...
  return (  
    <Box>
      ...
      >
        ...
        {(!postHovered)
          ?
           <img className={classes.imageOp} height={'auto'} width={imageDimensions.w} alt="user-post" src={image}  /> 
          : 
          <>
            <img className={classes.image} height={'auto'} width={imageDimensions.w} alt="user-post" src={image}  />
