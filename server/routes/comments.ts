import { createComment, deleteComment, deleteReply, getComments, heartCommentPin, heartReplyPin, unheartCommentPin, unheartReplyPin, updateComment, updateReply } from '../controllers/comments'
